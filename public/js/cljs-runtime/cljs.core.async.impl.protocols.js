...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_27994 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_27994(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_27997 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_27997(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28005 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28005(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28014 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28014(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28017 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28017(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28032 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28032(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28034 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28034(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28036 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28036(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28040 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28040(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28046 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28046(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28048 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28048(b);
}
});
