...
var G__8236 = o;
goog.object.set(G__8236,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__8291__delegate = function (args){
...
var args = cljs.core.seq(arglist__8293);
...
var G__8237 = o;
goog.object.set(G__8237,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__8300__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__8300 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__8301__i = 0, G__8301__a = new Array(arguments.length -  0);
while (G__8301__i < G__8301__a.length) {G__8301__a[G__8301__i] = arguments[G__8301__i + 0]; ++G__8301__i;}
  args = new cljs.core.IndexedSeq(G__8301__a,0,null);
} 
...
var G__8238 = props;
var G__8238__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8238,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8238);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8238__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8244 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8244,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8244;
}
})(),id_class);
...
var G__8245 = (cljs.core.count(argv) - first_child);
switch (G__8245) {
case (0):
...
var vec__8251 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8251,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8251,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8251,(2),null);
...
var temp__5739__auto___8341 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___8341 == null)){
} else {
var key_8342 = temp__5739__auto___8341;
...
var temp__5739__auto___8346 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___8346 == null)){
} else {
var key_8347 = temp__5739__auto___8346;
(jsprops.key = key_8347);
}
...
var temp__5739__auto___8350 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___8350 == null)){
} else {
var key_8351 = temp__5739__auto___8350;
(jsprops.key = key_8351);
}
...
var temp__5739__auto___8355 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___8355 == null)){
} else {
var key_8357 = temp__5739__auto___8355;
(jsprops.key = key_8357);
}
...
var temp__5739__auto___8364 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___8364 == null)){
} else {
var key_8367 = temp__5739__auto___8364;
(jsprops.key = key_8367);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8265_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8265_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8268 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8268,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8268,(1),null);
...
break;
default:
var G__8393 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__8394 = compiler;
v = G__8393;
compiler = G__8394;
continue;
...
var G__8273 = tag;
var G__8273__$1 = (((G__8273 instanceof cljs.core.Keyword))?G__8273.fqn:null);
switch (G__8273__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template8278 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template8278 = (function (opts,id,fn_to_element,meta8279){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template8278.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8280,meta8279__$1){
var self__ = this;
var _8280__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8278(self__.opts,self__.id,self__.fn_to_element,meta8279__$1));
}));

(reagent.impl.template.t_reagent$impl$template8278.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8280){
var self__ = this;
var _8280__$1 = this;
return self__.meta8279;
}));

(reagent.impl.template.t_reagent$impl$template8278.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8278.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8278.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8278.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8278.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta8279","meta8279",-1796938396,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8278.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8278.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8278");

(reagent.impl.template.t_reagent$impl$template8278.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template8278");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8278.
 */
reagent.impl.template.__GT_t_reagent$impl$template8278 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template8278(opts__$1,id__$1,fn_to_element__$1,meta8279){
return (new reagent.impl.template.t_reagent$impl$template8278(opts__$1,id__$1,fn_to_element__$1,meta8279));
});

}

return (new reagent.impl.template.t_reagent$impl$template8278(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
