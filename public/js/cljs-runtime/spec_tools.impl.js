...
var vec__14071 = cljs.core.rest(expr);
...
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14074,(0),null);
var form = seq__14072__$1;
...
var G__14077 = x;
var G__14077__$1 = (((G__14077 == null))?null:spec_tools.impl.polish(G__14077));
var G__14077__$2 = (((G__14077__$1 == null))?null:cljs.core.name(G__14077__$1));
if((G__14077__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__14077__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__14078 = x;
var G__14078__$1 = (((G__14078 == null))?null:cljs.core.name(G__14078));
if((G__14078__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__14078__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__14079){
var map__14080 = p__14079;
var map__14080__$1 = (((((!((map__14080 == null))))?(((((map__14080.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14080.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14080):map__14080);
var data = map__14080__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14080__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14080__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14080__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14080__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__14082){
var map__14083 = p__14082;
var map__14083__$1 = (((((!((map__14083 == null))))?(((((map__14083.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14083.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14083):map__14083);
var data = map__14083__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14083__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14083__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__14085 = data;
var G__14085__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14085,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__14085);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14085__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__14085__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__14089 = form;
var G__14089__$1 = (((G__14089 == null))?null:cljs.core.rest(G__14089));
if((G__14089__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__14089__$1);
}
})();
var G__14090 = m;
var G__14090__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14090,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__14086_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__14086_SHARP_)));
})):G__14090);
var G__14090__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14090__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__14087_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__14087_SHARP_)));
})):G__14090__$1);
var G__14090__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__14090__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__14088_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__14088_SHARP_));
})):G__14090__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__14090__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__14091 = (function (){var G__14092 = form;
var G__14092__$1 = (((G__14092 == null))?null:cljs.core.rest(G__14092));
if((G__14092__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__14092__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14091__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14091__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14091__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14091__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__14094 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__14094) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__14095 = form;
var G__14095__$1 = (((G__14095 == null))?null:cljs.core.seq(G__14095));
var G__14095__$2 = (((G__14095__$1 == null))?null:cljs.core.first(G__14095__$1));
if((G__14095__$2 == null)){
return null;
} else {
var fexpr__14096 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__14096.cljs$core$IFn$_invoke$arity$1 ? fexpr__14096.cljs$core$IFn$_invoke$arity$1(G__14095__$2) : fexpr__14096.call(null,G__14095__$2));
}
})():null));
});
/**
...
var len__4736__auto___14125 = arguments.length;
var i__4737__auto___14126 = (0);
while(true){
if((i__4737__auto___14126 < len__4736__auto___14125)){
args__4742__auto__.push((arguments[i__4737__auto___14126]));

var G__14127 = (i__4737__auto___14126 + (1));
i__4737__auto___14126 = G__14127;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq14097){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14097));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__14098){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__14104){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14105__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14105__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14105__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14105__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__14102_SHARP_){
return cljs.core.map_QMARK_(p1__14102_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__14103_SHARP_){
return cljs.core.contains_QMARK_(p1__14103_SHARP_,x);
});
}),req_keys));
